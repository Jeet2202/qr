    ...
    <div className="min-h-screen bg-light-gray flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-royal to-royal-dark items-center justify-center p-12">
        <div className="max-w-md text-center">
          <img
            src={authImg}
            alt="HackFlow authentication"
            className="w-full h-auto rounded-2xl mb-8 shadow-2xl"
          />
          <h2 className="text-2xl font-bold text-white mb-3">
            Welcome Back to HackFlow
          </h2>
          <p className="text-blue-200/80 text-sm leading-relaxed">
            Sign in to access your hackathons, manage teams, and track submissions.
          </p>
        </div>
      </div>
        ...
        <AuthCard>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              ...
              <a href="#" className="text-sm font-medium text-royal hover:text-royal-light transition-colors">
                Forgot password?
              </a>
            </div>
          ...
          <p className="text-center text-sm text-gray-500 mt-8">
            ...
            <Link to="/signup" className="font-semibold text-royal hover:text-royal-light transition-colors">
              Sign Up
            </Link>
          </p>
        </AuthCard>
